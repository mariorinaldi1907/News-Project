...
git init
git add .
git commit -m "Initial Flask news website"
git branch -M main
git remote add origin https://github.com/your-username/news_project.git
...
This project does not use React. It uses Flask, Jinja templates, HTML, and CSS only.
